# Fiid [![CI](https://github.com/tsubery/fiid/actions/workflows/ci.yml/badge.svg)](https://github.com/tsubery/fiid/actions/workflows/ci.yml)

This app purpose is to manage personal media libraries of videos, audio & articles. It basically organizes all the feeds i like to listen/watch into a personal podcast feed and includes a built-in reading app for articles. Most notable features are:
* Built-in reading list
  *  Syncronize multiple rss feeds into a reading list
  *  Accept emails, render them as web pages and serve them as articles, similar functionality to [kill-the-newsletter](https://github.com/leafac/kill-the-newsletter)
  *  Add a particular webpage whenever content changes as a workaround for sites that lack rss
* Organize videos/podcasts into a personal podcast
...
2. *Feed* - A source for media items. Can represent an RSS feed, YouTube playlist, Youtube Channel or an Email Inbox.
3. *Library* - A destination for media items. A Library can represent a personal podcast that is compatible with PocketCasts or a reading list. It should be compatible with other podcast apps but I haven't tested it.
...
Running `rails db:seed` creates a ReadingLibrary, PodcastLibrary and Spam Inbox.
...
### Public endpoints
Videos are accessible using `/media_items/:media_item_id/video`.
...
Please check the terms of service of any 3rd party including Youtube before using this app with their services.
